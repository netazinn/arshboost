...
export const metadata: Metadata = buildMetadata({
  title: 'League of Legends Boost – ArshBoost',
  description: 'Order League of Legends rank boosting, win boosting and placement matches from ArshBoost.',
  path: '/league-of-legends/rank-boost',
  noIndex: false,
})

export default function LoLOrderPage() {
  return (
    <div className="relative flex min-h-screen flex-col bg-black">
      ...
      <main className="flex flex-1 items-center justify-center">
        <p className="font-mono text-sm tracking-[-0.07em] text-[#6e6d6f]">
          League of Legends Boost — coming soon.
        </p>
      </main>
    </div>
  )

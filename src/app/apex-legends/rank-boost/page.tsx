...
export const metadata: Metadata = buildMetadata({
  title: 'Apex Legends Boost – ArshBoost',
  description: 'Order Apex Legends rank boosting and win boosting from ArshBoost.',
  path: '/apex-legends/rank-boost',
  noIndex: false,
})

export default function ApexOrderPage() {
  return (
    <div className="relative flex min-h-screen flex-col bg-black">
      ...
      <main className="flex flex-1 items-center justify-center">
        <p className="font-mono text-sm tracking-[-0.07em] text-[#6e6d6f]">
          Apex Legends Boost — coming soon.
        </p>
      </main>
    </div>
  )
